...
#define MyAppName "Dragonfly power control X2 Driver"
...
AppId={{F1FA36A8-C5D5-4839-9E81-B4487B63F2F5}
AppName={#MyAppName}
...
OutputBaseFilename=DragonflyPower_X2_Installer
...
[Files]
Source: "powercontrollist DragonflyPower.txt";                  DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "powercontrollist DragonflyPower.txt";                  DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "powercontrollist64 DragonflyPower.txt"
; 32 bit
Source: "libDragonflyPower\Win32\Release\libDragonflyPower.dll";    DestDir: "{app}\Plugins\PowerControlPlugIns"; Flags: ignoreversion
Source: "DragonflyPower.ui";                                    DestDir: "{app}\Plugins\PowerControlPlugIns"; Flags: ignoreversion
Source: "Lunatico3.png";                                 DestDir: "{app}\Plugins\PowerControlPlugIns"; Flags: ignoreversion
; 64 bit
Source: "libDragonflyPower\x64\Release\libDragonflyPower.dll";      DestDir: "{app}\Plugins64\PowerControlPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\PowerControlPlugIns'))
Source: "DragonflyPower.ui";                                    DestDir: "{app}\Plugins64\PowerControlPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\PowerControlPlugIns'))
Source: "Lunatico3.png";                                 DestDir: "{app}\Plugins64\PowerControlPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\PowerControlPlugIns'))
